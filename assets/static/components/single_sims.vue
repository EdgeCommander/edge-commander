...
module.exports = {
  ...
  methods: {
    ...
    onMorrisSuccess: function (result, status, jqXHR) {
      ...
      let todayDate = module.exports.methods.getActualFullDate()

      let dateExist =  module.exports.methods.dateExist(result.chartjs_data, todayDate);
      if(dateExist == false){
        let val = module.exports.methods.getUsageValue(result.chartjs_data, todayDate)
