...
import DataTable from "../../assets/js/jquery.dataTables.min.js";
  ...
  methods: {
   ...
   dateFilterInitialize: function() {
    ...
    $('#m_sms_datepicker_from, #m_sms_datepicker_to').change(function(){
      let from_date = activities.methods.date_format("m_sms_datepicker_from");
      let to_date = activities.methods.date_format("m_sms_datepicker_to");
