<template>
<div>
    <edit-modal :showModal="showModal" :editData="editData" :user_id="user_id"/>
    <div class="m-content">
...
import SiteFilters from "./site_filters";
import EditModal from "./site_edit";
...
export default {
  ...
  mounted() {
    ...
    this.$events.$on('site-added', e => this.onAdded())
    ...
    onActionClicked(action, data) {
      if (action == "delete-item") {
        if (window.confirm("Are you sure you want to delete this Site?")) {
          this.$http.delete(`/sites/${data.id}`).then(response => {
            this.$notify({group: 'notify', title: 'Site has been deleted.'});
          }, error => {
