                  ...
                  <div class="col-md-8">
                    <div class="row">
                        <div class="col-sm-6">
                            ...
                            <div class="col-lg-10">
                                <input type="text" class="form-control m-input m-input--solid" id="m_sms_datepicker_from" autocomplete="off">
                            </div>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            ...
                            <div class="col-lg-10">
                                <input type="text" class="form-control m-input m-input--solid" id="m_sms_datepicker_to" autocomplete="off">
                            </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content" style="padding: 0px;">
                ...
                <div class="modal-body" id="body-sms-dis">
                    <img src="../../assets/images/loading.gif" id="api-wait" class="hide_me">
  ...
  methods: {
    ...
    dateFilterInitialize: function() {
      ...
      $('#m_sms_datepicker_from, #m_sms_datepicker_to').change(function(){
          let from_date = messages.methods.date_format("m_sms_datepicker_from");
          let to_date = messages.methods.date_format("m_sms_datepicker_to");
    ...
    onSmsButton: function() {
      jquery(this.$refs.addmodal).modal('show');
    },
